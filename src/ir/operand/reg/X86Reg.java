...
public class X86Reg extends Reg{
    ...
    public static X86Reg rsi = new X86Reg("rsi", 3);
    public static X86Reg rdi = new X86Reg("rdi", 4);
    public static X86Reg r8 = new X86Reg("r8", 1);
    public static X86Reg r9 = new X86Reg("r9", 2);
    public static X86Reg r10 = new X86Reg("r10", 0);
    public static X86Reg r11 = new X86Reg("r11", 5);
