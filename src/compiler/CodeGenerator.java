...
public class CodeGenerator {
    ...
    public void Builtin() {
        ...
        ans += "\tmov     rbp, rsp\n";
        ans += "\tmov     qword [rbp-18H], rdi\n";
        ans += "\tmov     qword [rbp-20H], rsi\n";
        ans += "\tmov     dword [rbp-0CH], 0\n";
        ans += "\tmov     dword [rbp-8H], 0\n";
        ans += "\tjmp     Leq_002\n";
        ans += "Leq_001:  add     dword [rbp-0CH], 1\n";
        ans += "Leq_002:  mov     eax, dword [rbp-0CH]\n";
        ans += "\tmovsxd  rdx, eax\n";
        ans += "\tmov     rax, qword [rbp-18H]\n";
        ans += "\tadd     rax, rdx\n";
        ans += "\tmovzx   eax, byte [rax]\n";
        ...
        ans += "\tjg      Leq_001\n";
        ans += "\tjmp     Leq_004\n";
        ans += "Leq_003:  add     dword [rbp-8H], 1\n";
        ans += "Leq_004:  mov     eax, dword [rbp-8H]\n";
        ans += "\tmovsxd  rdx, eax\n";
        ans += "\tmov     rax, qword [rbp-20H]\n";
        ans += "\tadd     rax, rdx\n";
        ans += "\tmovzx   eax, byte [rax]\n";
        ans += "\ttest    al, al\n";
        ans += "\tjz      Leq_005\n";
        ans += "\tmov     eax, dword [rbp-8H]\n";
        ans += "\tmovsxd  rdx, eax\n";
        ans += "\tmov     rax, qword [rbp-20H]\n";
        ans += "\tadd     rax, rdx\n";
        ans += "\tmovzx   eax, byte [rax]\n";
        ...
        ans += "\tcmp     al, 57\n";
        ans += "\tjg      Leq_003\n";
        ans += "Leq_005:  mov     eax, dword [rbp-0CH]\n";
        ans += "\tcmp     eax, dword [rbp-8H]\n";
        ans += "\tjz      Leq_006\n";
        ans += "\tmov     eax, 0\n";
        ans += "\tjmp     Leq_010\n";
        ans += "Leq_006:  mov     dword [rbp-4H], 0\n";
        ans += "\tmov     dword [rbp-4H], 0\n";
        ans += "\tjmp     Leq_009\n";
        ans += "Leq_007:  mov     eax, dword [rbp-4H]\n";
        ans += "\tmovsxd  rdx, eax\n";
        ans += "\tmov     rax, qword [rbp-18H]\n";
        ans += "\tadd     rax, rdx\n";
        ans += "\tmovzx   edx, byte [rax]\n";
        ans += "\tmov     eax, dword [rbp-4H]\n";
        ans += "\tmovsxd  rcx, eax\n";
        ans += "\tmov     rax, qword [rbp-20H]\n";
        ans += "\tadd     rax, rcx\n";
        ...
        ans += "\tmov     eax, 0\n";
        ans += "\tjmp     Leq_010\n";
        ans += "Leq_008:  add     dword [rbp-4H], 1\n";
        ans += "Leq_009:  mov     eax, dword [rbp-4H]\n";
        ans += "\tcmp     eax, dword [rbp-0CH]\n";
        ans += "\tjl      Leq_007\n";
        ans += "\tmov     eax, 1\n";
        ans += "Leq_010:  pop     rbp\n";
        ...
        ans +="\tmov     dword [rbp-0CH], 0\n";
        ans +="\tjmp     Ll_012\n";
        ans +="Ll_011:  add     dword [rbp-10H], 1\n";
        ans +="Ll_012:  mov     eax, dword [rbp-10H]\n";
        ans +="\tmovsxd  rdx, eax\n";
        ans +="\tmov     rax, qword [rbp-18H]\n";
        ans +="\tadd     rax, rdx\n";
        ans +="\tmovzx   eax, byte [rax]\n";
        ...
        ans +="\tjg      Ll_011\n";
        ans +="\tjmp     Ll_014\n";
        ans +="Ll_013:  add     dword [rbp-0CH], 1\n";
        ans +="Ll_014:  mov     eax, dword [rbp-0CH]\n";
        ans +="\tmovsxd  rdx, eax\n";
        ans +="\tmov     rax, qword [rbp-20H]\n";
        ans +="\tadd     rax, rdx\n";
        ans +="\tmovzx   eax, byte [rax]\n";
        ...
        ans +="\tcmp     al, 57\n";
        ans +="\tjg      Ll_013\n";
        ans +="Ll_015:  mov     eax, dword [rbp-0CH]\n";
        ans +="\tcmp     dword [rbp-10H], eax\n";
        ans +="\tcmovle  eax, dword [rbp-10H]\n";
        ans +="\tmov     dword [rbp-4H], eax\n";
        ans +="\tmov     dword [rbp-8H], 0\n";
        ans +="\tmov     dword [rbp-8H], 0\n";
        ans +="\tjmp     Ll_019\n";
        ans +="Ll_016:  mov     eax, dword [rbp-8H]\n";
        ans +="\tmovsxd  rdx, eax\n";
        ans +="\tmov     rax, qword [rbp-18H]\n";
        ans +="\tadd     rax, rdx\n";
        ans +="\tmovzx   edx, byte [rax]\n";
        ...
        ans +="\tmov     eax, 1\n";
        ans +="\tjmp     Ll_021\n";
        ans +="Ll_017:  mov     eax, dword [rbp-8H]\n";
        ans +="\tmovsxd  rdx, eax\n";
        ans +="\tmov     rax, qword [rbp-18H]\n";
        ans +="\tadd     rax, rdx\n";
        ans +="\tmovzx   edx, byte [rax]\n";
        ...
        ans +="\tmov     eax, 0\n";
        ans +="\tjmp     Ll_021\n";
        ans +="Ll_018:  add     dword [rbp-8H], 1\n";
        ans +="Ll_019:  mov     eax, dword [rbp-8H]\n";
        ans +="\tcmp     eax, dword [rbp-4H]\n";
        ans +="\tjl      Ll_016\n";
        ans +="\tmov     eax, dword [rbp-10H]\n";
        ans +="\tcmp     eax, dword [rbp-0CH]\n";
        ans +="\tjl      Ll_020\n";
        ...
        ans += "\tmov     dword [rbp-0CH], 0\n";
        ans += "\tjmp     Lg_023\n";
        ans += "Lg_022:  add     dword [rbp-10H], 1\n";
        ans += "Lg_023:  mov     eax, dword [rbp-10H]\n";
        ans += "\tmovsxd  rdx, eax\n";
        ans += "\tmov     rax, qword [rbp-18H]\n";
        ans += "\tadd     rax, rdx\n";
        ans += "\tmovzx   eax, byte [rax]\n";
        ...
        ans += "\tjg      Lg_022\n";
        ans += "\tjmp     Lg_025\n";
        ans += "Lg_024:  add     dword [rbp-0CH], 1\n";
        ans += "Lg_025:  mov     eax, dword [rbp-0CH]\n";
        ans += "\tmovsxd  rdx, eax\n";
        ans += "\tmov     rax, qword [rbp-20H]\n";
        ans += "\tadd     rax, rdx\n";
        ans += "\tmovzx   eax, byte [rax]\n";
        ...
        ans += "\tcmp     al, 57\n";
        ans += "\tjg      Lg_024\n";
        ans += "Lg_026:  mov     eax, dword [rbp-0CH]\n";
        ans += "\tcmp     dword [rbp-10H], eax\n";
        ans += "\tcmovle  eax, dword [rbp-10H]\n";
        ans += "\tmov     dword [rbp-4H], eax\n";
        ans += "\tmov     dword [rbp-8H], 0\n";
        ans += "\tmov     dword [rbp-8H], 0\n";
        ans += "\tjmp     Lg_030\n";
        ans += "Lg_027:  mov     eax, dword [rbp-8H]\n";
        ans += "\tmovsxd  rdx, eax\n";
        ans += "\tmov     rax, qword [rbp-18H]\n";
        ans += "\tadd     rax, rdx\n";
        ans += "\tmovzx   edx, byte [rax]\n";
        ...
        ans += "\tmov     eax, 1\n";
        ans += "\tjmp     Lg_032\n";
        ans += "Lg_028:  mov     eax, dword [rbp-8H]\n";
        ans += "\tmovsxd  rdx, eax\n";
        ans += "\tmov     rax, qword [rbp-18H]\n";
        ans += "\tadd     rax, rdx\n";
        ans += "\tmovzx   edx, byte [rax]\n";
        ...
        ans += "\tmov     eax, 0\n";
        ans += "\tjmp     Lg_032\n";
        ans += "Lg_029:  add     dword [rbp-8H], 1\n";
        ans += "Lg_030:  mov     eax, dword [rbp-8H]\n";
        ans += "\tcmp     eax, dword [rbp-4H]\n";
        ans += "\tjl      Lg_027\n";
        ans += "\tmov     eax, dword [rbp-10H]\n";
        ans += "\tcmp     eax, dword [rbp-0CH]\n";
